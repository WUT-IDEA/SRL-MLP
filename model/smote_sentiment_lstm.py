...
np.save(path.join(path.dirname(__file__),'..','np_data','smote_jd_doc2matrix'), X)
np.save(path.join(path.dirname(__file__),'..','np_data','smote_jd_label'), Y)
...
model.save_weights(path.join(path.dirname(__file__),'..','model','smote_sentiment_lstm.h5'),overwrite=1)
...
pd.to_pickle(text, path.join(path.dirname(__file__),'..','np_data','smote_label_text_sentistatics_pd'))
...
print(senti.shape)
np.save(path.join(path.dirname(__file__),'..','np_data','smote_vectors_senti.npy'), senti)
print('end')
